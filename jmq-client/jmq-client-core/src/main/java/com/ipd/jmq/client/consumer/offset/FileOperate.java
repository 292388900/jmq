...
public class FileOperate {
    ...
    public static final void string2FileNotSafe(final String str, final String fileName) throws IOException {
        ...
        try {
            ...
            ByteBuffer byteBuffer = ByteBuffer.wrap(str.getBytes(Charsets.UTF_8));
    ...
    public static final String file2String(final File file) {
        ...
        try {
            ...
            while (true) {
                ...
                byteBuffer.flip();
                charBuffer = Charsets.UTF_8.decode(byteBuffer.asReadOnlyBuffer());
            ...
            logger.error("read byte buffer error", e);
        } finally {
            if (fileChannel != null) {
                try {
                    fileChannel.close();
