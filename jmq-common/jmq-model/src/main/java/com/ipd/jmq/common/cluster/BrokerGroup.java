...
import com.ipd.jmq.common.cluster.Broker.BrokerType;
...
public class  BrokerGroup implements Serializable {
    ...
    public BrokerGroup(String address, Map<String, Broker> brokers) {
        this(null, address, brokers);
    }

    public BrokerGroup(String group, String address, Map<String, Broker> brokers) {
        this.group = group;
     ...
     */
    public List<Broker> getBackups() {
        List<Broker> backups = new ArrayList<Broker>();
