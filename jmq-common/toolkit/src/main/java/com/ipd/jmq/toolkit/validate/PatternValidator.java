...
public class PatternValidator implements Validator {
    ...
    public void validate(final Object target, final Annotation annotation, final Value value) throws ValidateException {
        com.ipd.jmq.toolkit.validate.annotation.Pattern pattern =
                (com.ipd.jmq.toolkit.validate.annotation.Pattern) annotation;
        ...
        if (matcher.find() ? pattern.flag() : !pattern.flag()) {
