package com.ipd.jmq.toolkit.service;

import com.ipd.jmq.toolkit.config.Context;
import com.ipd.jmq.toolkit.config.ContextKey;
import com.ipd.jmq.toolkit.config.Postman;
import com.ipd.jmq.toolkit.lang.Pair;
import com.ipd.jmq.toolkit.time.CronExpression;
...
public abstract class WorkerService extends Service {
    ...
    protected class Worker extends ServiceThread {
        ...
        public Worker(long interval) {
            ...
            // 表示需要初始化调度时间
            this.initialDelay = interval < 0 ? false : true;
        }
