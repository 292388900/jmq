...
import static com.ipd.jmq.toolkit.lang.Preconditions.checkArgument;
import static com.ipd.jmq.toolkit.lang.Preconditions.checkNotNull;
...
public final class Functions {
    ...
    static class MapFunction<K, V> implements Function<K, V>, Serializable {
        ...
        public V apply(final K key) {
            ...
            checkArgument(false, "Key '%s' not present in map", key);
            return result;
        }
