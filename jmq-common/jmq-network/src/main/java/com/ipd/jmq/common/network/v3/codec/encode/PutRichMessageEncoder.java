...
import com.ipd.jmq.common.network.v3.command.PutRichMessage;
 ...
 * 发送消息编码器
 */
public class PutRichMessageEncoder implements PayloadEncoder<PutRichMessage> {

    @Override
    public void encode(final PutRichMessage payload, final ByteBuf out) throws Exception {
        payload.validate();
        // 1字节生产者ID长度
    ...
    @Override
    public int type() {
        return CmdTypes.PUT_MESSAGE_RICH;
    }
}