...
import com.ipd.jmq.common.network.protocol.telnet.*;
...
public class TelnetDecoder extends ByteToMessageDecoder {
    ...
    public TelnetDecoder(CommandHandlerFactory factory) {
        this(factory, ">", 100);
    }

    public TelnetDecoder(CommandHandlerFactory factory, String prompt, int maxHistorySize, EnterHandler handler) {
        if (factory == null) {
    ...
    public TelnetDecoder(CommandHandlerFactory factory, String prompt, int maxHistorySize) {
         this(factory, prompt, maxHistorySize, null);
    }
