 ...
 * Telnent编码器
 */
public class TelnetServerEncoder extends MessageToByteEncoder<Command> {

    protected Encoder encoder;
    protected String prompt = ">";

    public TelnetServerEncoder() {
        super();
    }

    public TelnetServerEncoder(String prompt, Encoder encoder) {
        super();
        this.prompt = prompt;
