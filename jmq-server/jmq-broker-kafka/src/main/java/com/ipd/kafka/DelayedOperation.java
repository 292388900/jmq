...
import com.ipd.jmq.common.network.kafka.utils.timer.TimerTask;
...
public abstract class DelayedOperation extends TimerTask {
    ...
    public DelayedOperation(long dealyMs) {
        // 不加当前时间导致 TimerTask 很快就触发，从而影响多个消费者实例下的 Rebalance
        this.delayMs = dealyMs + System.currentTimeMillis();
    }
